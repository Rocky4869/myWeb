...
/*==================== INTERESTS SWIPER  ====================*/
let swiperInterests = new Swiper(".interests__container", {
    cssMode: true,
    loop: true,
...
const sendEmail = (e) => {
    ...
    if (contactName.value === '' || contactEmail.value === '' || contactProject.value === '' || contactMessage.value === '') {
        ...
        emailjs.sendForm('service_j31pd5j', 'template_io62inl', '#contact-form', '7j2HGj6Dz8tzKzk1h')
            .then(() => {
...
sr.reveal('.home__data, .about__data, .skills__header, .qualification__tabs, .footer__title, .footer__subtitle', {});
sr.reveal('.button, .experiences__title, .experiences__icon, .contact__information, #p1, #p2', { delay: 200 });
sr.reveal('.home__blob-img, .skills__data, .about__img, .contact__form, .footer__link', { interval: 200 });
